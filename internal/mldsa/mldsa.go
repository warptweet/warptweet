...
//
// Package mldsa is FIPS 204 ML-DSA adapted from Go's crypto/internal/fips140/mldsa
// so WarpTweet can sign OpenSSH vendor-qualified composite host keys without
// importing stdlib internal packages.
