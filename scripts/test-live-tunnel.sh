...
require_account() {
    ...
    IFS=: read -r WT_ACCOUNT_NAME WT_ACCOUNT_PASSWORD WT_ACCOUNT_UID WT_ACCOUNT_GID WT_ACCOUNT_GECOS WT_ACCOUNT_ACTUAL_HOME WT_ACCOUNT_ACTUAL_SHELL <<EOF
$WT_ACCOUNT_ENTRY
EOF
...
require_public_key_only_account() {
    ...
    IFS=: read -r WT_SHADOW_NAME WT_SHADOW_PASSWORD WT_SHADOW_CHANGED WT_SHADOW_MINIMUM WT_SHADOW_MAXIMUM WT_SHADOW_WARNING WT_SHADOW_INACTIVE WT_SHADOW_EXPIRES WT_SHADOW_RESERVED <<EOF
$WT_SHADOW_ENTRY
EOF
...
provision_dedicated_client_account() {
    ...
    IFS=: read -r WT_CLIENT_ACCOUNT_NAME WT_CLIENT_ACCOUNT_PASSWORD WT_CLIENT_UID WT_CLIENT_GID WT_CLIENT_GECOS WT_CLIENT_HOME WT_CLIENT_SHELL <<EOF
