...
- Linux host `.deb`: `dist/warptweet_0.1.0-rc.4_amd64.deb`
...
scp dist/warptweet_0.1.0-rc.4_amd64.deb ubuntu@"$HOST":/tmp/
ssh ubuntu@"$HOST" 'sudo dpkg -i /tmp/warptweet_0.1.0-rc.4_amd64.deb'
```
